...
func (r ApiAuthenticateRequest) RestAuthenticationRequest(restAuthenticationRequest RestAuthenticationRequest) ApiAuthenticateRequest {
	r.restAuthenticationRequest = &restAuthenticationRequest
	return r
}

func (r ApiAuthenticateRequest) Execute() (*RestApplicationUserWithPermissions, *http.Response, error) {
...
*/
func (a *MirroringUpstreamAPIService) Authenticate(ctx context.Context) ApiAuthenticateRequest {
	return ApiAuthenticateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MirroringUpstreamAPIService) AuthenticateExecute(r ApiAuthenticateRequest) (*RestApplicationUserWithPermissions, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MirroringUpstreamAPIService.Authenticate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *MirroringUpstreamAPIService) GetAllContentHashesExecute(r ApiGetAllContentHashesRequest) (*EnrichedRepository, *http.Response, error) {
	...
	if r.includeDefaultBranch != nil {
		...
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeDefaultBranch", defaultValue, "form", "")
