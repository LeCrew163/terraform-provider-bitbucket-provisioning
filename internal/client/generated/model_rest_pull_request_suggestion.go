...
func (o *RestPullRequestSuggestion) GetRepository() RestCommentAnchorPullRequestFromRefRepository {
...
// and a boolean to check if the value has been set.
func (o *RestPullRequestSuggestion) GetRepositoryOk() (*RestCommentAnchorPullRequestFromRefRepository, bool) {
	if o == nil || IsNil(o.Repository) {
		return nil, false
	}
...
func (o *RestPullRequestSuggestion) SetRepository(v RestCommentAnchorPullRequestFromRefRepository) {
	o.Repository = &v
}
