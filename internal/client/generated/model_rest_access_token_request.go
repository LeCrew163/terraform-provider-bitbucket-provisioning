...
type _RestAccessTokenRequest RestAccessTokenRequest

// NewRestAccessTokenRequest instantiates a new RestAccessTokenRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRestAccessTokenRequest(permissions []string) *RestAccessTokenRequest {
...
func (o *RestAccessTokenRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRestAccessTokenRequest := _RestAccessTokenRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestAccessTokenRequest)

	if err != nil {
		return err
	}

	*o = RestAccessTokenRequest(varRestAccessTokenRequest)
