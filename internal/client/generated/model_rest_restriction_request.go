...
type _RestRestrictionRequest RestRestrictionRequest

// NewRestRestrictionRequest instantiates a new RestRestrictionRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRestRestrictionRequest(accessKeyIds []int32, groupNames []string, userSlugs []string) *RestRestrictionRequest {
...
// GetAccessKeyIds returns the AccessKeyIds field value
...
// GetAccessKeyIdsOk returns a tuple with the AccessKeyIds field value
...
// SetAccessKeyIds sets field value
...
// GetUserSlugs returns the UserSlugs field value
...
// GetUserSlugsOk returns a tuple with the UserSlugs field value
// and a boolean to check if the value has been set.
...
func (o *RestRestrictionRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRestRestrictionRequest := _RestRestrictionRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestRestrictionRequest)

	if err != nil {
		return err
	}

	*o = RestRestrictionRequest(varRestRestrictionRequest)
