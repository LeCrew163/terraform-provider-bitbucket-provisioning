...
func (o *RestMigrationRepository) GetRepository() RestCommentAnchorPullRequestFromRefRepository {
...
// and a boolean to check if the value has been set.
func (o *RestMigrationRepository) GetRepositoryOk() (*RestCommentAnchorPullRequestFromRefRepository, bool) {
	if o == nil || IsNil(o.Repository) {
		return nil, false
	}
...
func (o *RestMigrationRepository) SetRepository(v RestCommentAnchorPullRequestFromRefRepository) {
	o.Repository = &v
}
