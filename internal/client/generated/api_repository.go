...
func (r ApiDeleteBranchRequest) RestBranchDeleteRequest(restBranchDeleteRequest RestBranchDeleteRequest) ApiDeleteBranchRequest {
...
func (a *RepositoryAPIService) DeleteBranchExecute(r ApiDeleteBranchRequest) (*http.Response, error) {
	...
	// body params
	localVarPostBody = r.restBranchDeleteRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
// The commit hash or fully-qualified ref name (e.g. refs/tags/example) to stream an archive of; if not supplied, an archive of the default branch is streamed
...
func (a *RepositoryAPIService) GetRepositoriesRecentlyAccessedExecute(r ApiGetRepositoriesRecentlyAccessedRequest) (*GetRepositoriesRecentlyAccessed200Response, *http.Response, error) {
	...
	if r.permission != nil {
		...
		parameterAddToHeaderOrQuery(localVarQueryParams, "permission", defaultValue, "form", "")
...
func (r ApiGetStatusRequest) At(at string) ApiGetStatusRequest {
	r.at = &at
	return r
}

func (r ApiGetStatusRequest) Execute() (*RestRefSyncStatus, *http.Response, error) {
...
*/
func (a *RepositoryAPIService) GetStatus(ctx context.Context, projectKey string, repositorySlug string) ApiGetStatusRequest {
	return ApiGetStatusRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
func (a *RepositoryAPIService) GetStatusExecute(r ApiGetStatusRequest) (*RestRefSyncStatus, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RepositoryAPIService.GetStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
