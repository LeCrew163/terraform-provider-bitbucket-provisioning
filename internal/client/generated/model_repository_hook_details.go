...
// GetConfigFormView returns the ConfigFormView field value if set, zero value otherwise.
func (o *RepositoryHookDetails) GetConfigFormView() string {
	if o == nil || IsNil(o.ConfigFormView) {
		var ret string
		return ret
	}
	return *o.ConfigFormView
}

// GetConfigFormViewOk returns a tuple with the ConfigFormView field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RepositoryHookDetails) GetConfigFormViewOk() (*string, bool) {
	if o == nil || IsNil(o.ConfigFormView) {
		return nil, false
	}
	return o.ConfigFormView, true
}

// HasConfigFormView returns a boolean if a field has been set.
func (o *RepositoryHookDetails) HasConfigFormView() bool {
	if o != nil && !IsNil(o.ConfigFormView) {
		return true
	}
...
// SetConfigFormView gets a reference to the given string and assigns it to the ConfigFormView field.
func (o *RepositoryHookDetails) SetConfigFormView(v string) {
	o.ConfigFormView = &v
}
...
func (o RepositoryHookDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ConfigFormView) {
		toSerialize["configFormView"] = o.ConfigFormView
	}
