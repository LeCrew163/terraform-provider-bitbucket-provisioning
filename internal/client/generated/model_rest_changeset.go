...
func (o *RestChangeset) GetRepository() RestCommentAnchorPullRequestFromRefRepository {
...
// and a boolean to check if the value has been set.
func (o *RestChangeset) GetRepositoryOk() (*RestCommentAnchorPullRequestFromRefRepository, bool) {
	if o == nil || IsNil(o.Repository) {
		return nil, false
	}
...
func (o *RestChangeset) SetRepository(v RestCommentAnchorPullRequestFromRefRepository) {
	o.Repository = &v
}
