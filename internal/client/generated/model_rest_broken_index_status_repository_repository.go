...
func (o *RestBrokenIndexStatusRepositoryRepository) GetOrigin() RestCommentAnchorPullRequestFromRefRepositoryOrigin {
...
// and a boolean to check if the value has been set.
func (o *RestBrokenIndexStatusRepositoryRepository) GetOriginOk() (*RestCommentAnchorPullRequestFromRefRepositoryOrigin, bool) {
	if o == nil || IsNil(o.Origin) {
		return nil, false
	}
...
func (o *RestBrokenIndexStatusRepositoryRepository) SetOrigin(v RestCommentAnchorPullRequestFromRefRepositoryOrigin) {
	o.Origin = &v
}
...
func (o *RestBrokenIndexStatusRepositoryRepository) GetProject() RestCommentAnchorPullRequestFromRefRepositoryOriginProject {
...
// and a boolean to check if the value has been set.
func (o *RestBrokenIndexStatusRepositoryRepository) GetProjectOk() (*RestCommentAnchorPullRequestFromRefRepositoryOriginProject, bool) {
	if o == nil || IsNil(o.Project) {
		return nil, false
	}
...
func (o *RestBrokenIndexStatusRepositoryRepository) SetProject(v RestCommentAnchorPullRequestFromRefRepositoryOriginProject) {
	o.Project = &v
}
