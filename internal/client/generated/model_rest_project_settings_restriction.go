...
func (o *RestProjectSettingsRestriction) GetProject() RestCommentAnchorPullRequestFromRefRepositoryOriginProject {
...
// and a boolean to check if the value has been set.
func (o *RestProjectSettingsRestriction) GetProjectOk() (*RestCommentAnchorPullRequestFromRefRepositoryOriginProject, bool) {
	if o == nil || IsNil(o.Project) {
		return nil, false
	}
...
func (o *RestProjectSettingsRestriction) SetProject(v RestCommentAnchorPullRequestFromRefRepositoryOriginProject) {
	o.Project = &v
}
