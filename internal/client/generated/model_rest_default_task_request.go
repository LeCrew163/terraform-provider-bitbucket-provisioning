...
type _RestDefaultTaskRequest RestDefaultTaskRequest

// NewRestDefaultTaskRequest instantiates a new RestDefaultTaskRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRestDefaultTaskRequest(description string) *RestDefaultTaskRequest {
...
func (o *RestDefaultTaskRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRestDefaultTaskRequest := _RestDefaultTaskRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestDefaultTaskRequest)

	if err != nil {
		return err
	}

	*o = RestDefaultTaskRequest(varRestDefaultTaskRequest)
