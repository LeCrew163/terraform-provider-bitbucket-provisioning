...
func (o *RestDeployment) GetRepository() RestCommentAnchorPullRequestFromRefRepository {
...
// and a boolean to check if the value has been set.
func (o *RestDeployment) GetRepositoryOk() (*RestCommentAnchorPullRequestFromRefRepository, bool) {
	if o == nil || IsNil(o.Repository) {
		return nil, false
	}
...
func (o *RestDeployment) SetRepository(v RestCommentAnchorPullRequestFromRefRepository) {
	o.Repository = &v
}
