...
func Test_bitbucket_SecurityAPIService(t *testing.T) {
	...
	t.Run("Test SecurityAPIService AddExemptRepo", func(t *testing.T) {
		...
		httpRes, err := apiClient.SecurityAPI.AddExemptRepo(context.Background()).Execute()
	...
	t.Run("Test SecurityAPIService BulkAddExemptRepositories1", func(t *testing.T) {
		...
		httpRes, err := apiClient.SecurityAPI.BulkAddExemptRepositories1(context.Background()).Execute()
	...
	t.Run("Test SecurityAPIService DeleteExemptRepo", func(t *testing.T) {
		...
		httpRes, err := apiClient.SecurityAPI.DeleteExemptRepo(context.Background()).Execute()
	...
	t.Run("Test SecurityAPIService FindExemptReposByProject", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityAPI.FindExemptReposByProject(context.Background()).Execute()
	...
	t.Run("Test SecurityAPIService IsRepoExempt", func(t *testing.T) {
		...
		httpRes, err := apiClient.SecurityAPI.IsRepoExempt(context.Background()).Execute()
	...
	t.Run("Test SecurityAPIService Search3", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.SecurityAPI.Search3(context.Background(), projectKey, repositorySlug).Execute()
