...
func Test_bitbucket_MirroringUpstreamAPIService(t *testing.T) {
	...
	t.Run("Test MirroringUpstreamAPIService Authenticate", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.MirroringUpstreamAPI.Authenticate(context.Background()).Execute()
