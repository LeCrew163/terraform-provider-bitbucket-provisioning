...
func Test_bitbucket_RepositoryAPIService(t *testing.T) {
	...
	t.Run("Test RepositoryAPIService GetStatus", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.RepositoryAPI.GetStatus(context.Background(), projectKey, repositorySlug).Execute()
