...
func (o *RestPullRequestRef) GetRepository() RestCommentAnchorPullRequestFromRefRepository {
...
// and a boolean to check if the value has been set.
func (o *RestPullRequestRef) GetRepositoryOk() (*RestCommentAnchorPullRequestFromRefRepository, bool) {
	if o == nil || IsNil(o.Repository) {
		return nil, false
	}
...
func (o *RestPullRequestRef) SetRepository(v RestCommentAnchorPullRequestFromRefRepository) {
	o.Repository = &v
}
