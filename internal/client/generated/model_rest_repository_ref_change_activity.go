...
func (o *RestRepositoryRefChangeActivity) GetRepository() RestCommentAnchorPullRequestFromRefRepository {
...
// and a boolean to check if the value has been set.
func (o *RestRepositoryRefChangeActivity) GetRepositoryOk() (*RestCommentAnchorPullRequestFromRefRepository, bool) {
	if o == nil || IsNil(o.Repository) {
		return nil, false
	}
...
func (o *RestRepositoryRefChangeActivity) SetRepository(v RestCommentAnchorPullRequestFromRefRepository) {
	o.Repository = &v
}
