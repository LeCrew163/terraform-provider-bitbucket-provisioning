...
func (o *RestMailConfiguration) GetAuthType() string {
...
func (o *RestMailConfiguration) GetAuthTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AuthType) {
		return nil, false
	}
...
func (o *RestMailConfiguration) HasAuthType() bool {
	if o != nil && !IsNil(o.AuthType) {
		return true
	}
...
func (o *RestMailConfiguration) SetAuthType(v string) {
	o.AuthType = &v
}
...
// GetOauth2ProviderId returns the Oauth2ProviderId field value if set, zero value otherwise.
func (o *RestMailConfiguration) GetOauth2ProviderId() string {
	if o == nil || IsNil(o.Oauth2ProviderId) {
		var ret string
		return ret
	}
	return *o.Oauth2ProviderId
}

// GetOauth2ProviderIdOk returns a tuple with the Oauth2ProviderId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RestMailConfiguration) GetOauth2ProviderIdOk() (*string, bool) {
	if o == nil || IsNil(o.Oauth2ProviderId) {
		return nil, false
	}
	return o.Oauth2ProviderId, true
}

// HasOauth2ProviderId returns a boolean if a field has been set.
func (o *RestMailConfiguration) HasOauth2ProviderId() bool {
	if o != nil && !IsNil(o.Oauth2ProviderId) {
		return true
	}
...
// SetOauth2ProviderId gets a reference to the given string and assigns it to the Oauth2ProviderId field.
func (o *RestMailConfiguration) SetOauth2ProviderId(v string) {
	o.Oauth2ProviderId = &v
}
...
func (o *RestMailConfiguration) GetTokenId() string {
...
// and a boolean to check if the value has been set.
func (o *RestMailConfiguration) GetTokenIdOk() (*string, bool) {
	if o == nil || IsNil(o.TokenId) {
		return nil, false
	}
...
func (o *RestMailConfiguration) HasTokenId() bool {
	if o != nil && !IsNil(o.TokenId) {
		return true
	}
...
func (o *RestMailConfiguration) SetTokenId(v string) {
	o.TokenId = &v
}
...
func (o RestMailConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Oauth2ProviderId) {
		toSerialize["oauth2ProviderId"] = o.Oauth2ProviderId
	}
	if !IsNil(o.Password) {
